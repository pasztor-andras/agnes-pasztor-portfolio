  ...
  return (
    <div className="mid-section public-section">
      <div className="public-container">
        ...
        <a href="https://scholar.google.com/citations?user=4vZlm9kAAAAJ&hl=en" target="_blank" rel="noopener noreferrer">
          Publications
        </a>
        <a href="https://medium.com/amboss/quality-engineering-70213186d4f4" target="_blank" rel="noopener noreferrer">
